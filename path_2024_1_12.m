...
parameter_collection_selection=linspace(0,1,parameter_idx)'; %The collection of selection intensity
...
for idx3=1:parameter_idx
    parameter_selection=parameter_collection_selection(idx3);
...
figure(1)
imagesc((parameter_c_main/2+1),parameter_collection_selection,result_sum)
ylabel('Selection Intensity')
xlabel('c_1/2+d_1') 
colorbar